...
public class JSONParser {
    ...
    /**
     * This is a common error routine for printing out the current location in
     * the file before printing the rest of the message.
     *
     * @param msg
     * @throws IOException
     */
    ...
    // MCZ 3/2014 - removing logic that checks for "valid" characters following
    // a back slash (\) - this seems like overkill for this and is preventing 
    // this from working on Windows systems.
