 ...
 * that each stage create reading that output will recieve all of the
 * input data.  This is the right kind of assignment to use when writing
 * out a single index file, for create, where you want all the data
 * that was generated by lots of parsing stage instances.</p>
 * 
 * <p>The "Each" mode means that every output stage create gets
