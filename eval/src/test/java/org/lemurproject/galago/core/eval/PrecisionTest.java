...
public class PrecisionTest {
  ...
  public void calculatePrecision() throws IOException {
    ...
    try{
      ...
      Assert.assertEquals(1.000, pFive.evaluate(qsr.get("1"), qsj.get("1")), .0001);
      Assert.assertEquals(0.000, pFive.evaluate(qsr.get("2"), qsj.get("2")), .0001);
      Assert.assertEquals(1.000, pFive.evaluate(qsr.get("3"), qsj.get("3")), .0001);
      Assert.assertEquals(0.600, pFive.evaluate(qsr.get("4"), qsj.get("4")), .0001);
      Assert.assertEquals(0.500, pTen.evaluate(qsr.get("1"), qsj.get("1")), .0001);
      Assert.assertEquals(0.500, pTen.evaluate(qsr.get("2"), qsj.get("2")), .0001);
      Assert.assertEquals(0.500, pTen.evaluate(qsr.get("3"), qsj.get("3")), .0001);
      Assert.assertEquals(0.600, pTen.evaluate(qsr.get("4"), qsj.get("4")), .0001);
    }
    finally{
      tmpQ.delete();
      tmpR.delete();
