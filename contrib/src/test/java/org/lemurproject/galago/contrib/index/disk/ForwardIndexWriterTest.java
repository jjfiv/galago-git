...
public class ForwardIndexWriterTest {
  ...
  public void testWriteThenRead() throws Exception {
    ...
    try {
      ...
      String tmp_manifestString = manifest.toString();
      // in Windows the filename gets double slashes which won't match
      String manifestString = tmp_manifestString.replace("\\\\", "\\");
