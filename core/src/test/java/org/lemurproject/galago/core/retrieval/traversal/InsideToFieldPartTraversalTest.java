...
public class InsideToFieldPartTraversalTest extends TestCase {
  ...
  public void testTraversal() throws Exception {
    ...
    inner1.set("extents", StreamExtentIterator.class.getName());
    ...
    inner2.set("extents", StreamExtentIterator.class.getName());
    ...
    Node q2 = StructuredQuery.copy(rewriter, q1, new Parameters()); // converts #text to #extents...
    Node q3 = StructuredQuery.copy(traversal, q2, new Parameters()); // converts #inside to #extents...
