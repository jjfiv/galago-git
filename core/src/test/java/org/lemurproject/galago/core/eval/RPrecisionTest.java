...
public class RPrecisionTest {
    ...
    try{
        ...
        assertEquals(1.000, rp.evaluate(qsr.get("1"), qsj.get("1")),.001);
        assertEquals(0.000, rp.evaluate(qsr.get("2"), qsj.get("2")),.001);
        assertEquals(1.000, rp.evaluate(qsr.get("3"), qsj.get("3")),.001);
        assertEquals(0.667, rp.evaluate(qsr.get("4"), qsj.get("4")),.001);
    }
        finally{
            tmpQ.delete();
            tmpR.delete();
