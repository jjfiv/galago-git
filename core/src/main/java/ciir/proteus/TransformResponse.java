...
public class TransformResponse implements org.apache.thrift.TBase<TransformResponse, TransformResponse._Fields>, java.io.Serializable, Cloneable {
  ...
  public TransformResponse setObjects(List<ProteusObject> objects) {
    this.objects = objects;
    return this;
  }
  ...
  public int compareTo(TransformResponse other) {
    ...
    TransformResponse typedOther = (TransformResponse)other;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.objects = new ArrayList<ProteusObject>(_list138.size);
                for (int _i139 = 0; _i139 < _list138.size; ++_i139)
                {
                  ProteusObject _elem140; // optional
                  _elem140 = new ProteusObject();
                  _elem140.read(iprot);
                  struct.objects.add(_elem140);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransformResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.objects != null) {
        oprot.writeFieldBegin(OBJECTS_FIELD_DESC);
        {
          ...
          for (ProteusObject _iter141 : struct.objects)
          {
      ...
      if (struct.isSetObjects()) {
        {
          ...
          for (ProteusObject _iter142 : struct.objects)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.objects = new ArrayList<ProteusObject>(_list143.size);
          for (int _i144 = 0; _i144 < _list143.size; ++_i144)
          {
            ProteusObject _elem145; // optional
            _elem145 = new ProteusObject();
            _elem145.read(iprot);
            struct.objects.add(_elem145);
          }
        }
        struct.setObjectsIsSet(true);
      }
