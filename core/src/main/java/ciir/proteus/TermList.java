            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.terms = new ArrayList<WeightedTerm>(_list40.size);
                for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                {
                  WeightedTerm _elem42; // optional
                  _elem42 = new WeightedTerm();
                  _elem42.read(iprot);
                  struct.terms.add(_elem42);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TermList struct) throws org.apache.thrift.TException {
      ...
      if (struct.terms != null) {
        oprot.writeFieldBegin(TERMS_FIELD_DESC);
        {
          ...
          for (WeightedTerm _iter43 : struct.terms)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetTerms()) {
        {
          ...
          for (WeightedTerm _iter44 : struct.terms)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.terms = new ArrayList<WeightedTerm>(_list45.size);
          for (int _i46 = 0; _i46 < _list45.size; ++_i46)
          {
            WeightedTerm _elem47; // optional
            _elem47 = new WeightedTerm();
            _elem47.read(iprot);
            struct.terms.add(_elem47);
          }
        }
        struct.setTermsIsSet(true);
      }
