 ...
 */
final public class StreamCountSource extends BTreeValueSource implements CountSource {
  ...
  public StreamCountSource(BTreeReader.BTreeIterator iter) throws IOException {
    super(iter);
    reset();
  }
