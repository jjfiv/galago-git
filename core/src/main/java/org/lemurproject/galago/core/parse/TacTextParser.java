 ...
 * @author jdalton
 */
public class TacTextParser implements DocumentStreamParser {
    BufferedReader reader;

    /** Creates a new instance of TrecTextParser */
    public TacTextParser(BufferedReader reader) throws FileNotFoundException, IOException {
        this.reader = reader;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i=0; i < 10; i++) {
            ...
            TacTextParser parser = new TacTextParser(new BufferedReader(new FileReader(tacFile)));
            Document doc = null;
