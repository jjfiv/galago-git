...
public class BM25FieldScoringIterator extends ScoringFunctionIterator 
  ...
  public void deltaScore() {
    ...
    /*
    System.err.printf("Update: (num=%f, den=%f, pot(%d)=%f, diff=%f, s=%f, max=%f, inc=%f) %f -> %f \n", 
            numerator, denominator, parentIdx, ctx.potentials[parentIdx], diff, 
            s, max, inc, ctx.runningScore, (ctx.runningScore+inc));
    */
