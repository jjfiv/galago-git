...
public class PL2FTraversal extends Traversal {
    ...
    public PL2FTraversal(Retrieval retrieval, Parameters qp) {
        ...
        params = globalParameters.containsKey("pl2f") ? globalParameters.getMap("pl2f") : new Parameters();
        ...
        fieldList = globalParameters.getAsList("fields");
    ...
    private void setTermStatistics(Node dfr, String t, double normalizer) throws Exception {
        ...
        Node parted = TextPartAssigner.assignPart(counter, retrieval.getAvailableParts(), globalParameters);
