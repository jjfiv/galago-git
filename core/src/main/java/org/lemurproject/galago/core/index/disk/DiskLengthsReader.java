...
//      documentLengthsIterator = new MemoryMapLengthsIterator(doc, documentLengths);
  ...
  public LengthsIterator getLengthsIterator() throws IOException {
    return new StreamLengthsIterator(getLengthsSource());
  }
  
  public StreamLengthsSource getLengthsSource() throws IOException {
    BTreeIterator it = reader.getIterator(doc);
    return new StreamLengthsSource(it);
  }
  ...
  public DiskIterator getIterator(Node node) throws IOException {
    ...
    if (node.getOperator().equals("lengths")) {
      ...
      return new StreamLengthsIterator(new StreamLengthsSource(i));
    } else {
  ...
  public class KeyIterator extends KeyListReader.KeyValueIterator {
    ...
    public StreamLengthsSource getStreamValueSource() throws IOException {
      return new StreamLengthsSource(iterator);
    }
    
    public StreamLengthsIterator getStreamValueIterator() throws IOException {
      return new StreamLengthsIterator(getStreamValueSource());
    }
