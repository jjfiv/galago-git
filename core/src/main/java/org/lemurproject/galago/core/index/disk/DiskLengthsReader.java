...
//    documentLengthsIterator = new MemoryMapLengthsIterator(doc, documentLengths);
  ...
  public int getLength(int document) throws IOException {
      StreamLengthsIterator iter = new StreamLengthsIterator(doc, reader.getIterator(Utility.fromString("document")));
      iter.moveTo(document);
      return iter.getCurrentLength();
  }
  ...
  public LengthsReader.Iterator getLengthsIterator() throws IOException {
    return (LengthsReader.Iterator) getIterator(new Node("lengths", "document"));
  }
...
//          return new MemoryMapLengthsIterator(keyBytes, i);
      ...
      return new StreamLengthsIterator(doc, reader.getIterator(doc));
    } else {
